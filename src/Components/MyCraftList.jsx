            ...
            <div className="">
                {   sortedCrafts.length === 0 ?
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-3 gap-5 px-4 py-4">
                        ...
                        <div key={craft._id}>
                            <div data-aos="fade-right" data-aos-duration="800" className=" flex flex-col overflow-x-hidden h-full md:h-[500px] lg:h-[570px] xl:h-[520px] w-full border-2 border-primary p-1  rounded-md shadow-md dark:bg-gray-50 dark:text-gray-800">
                                <img src={craft.itemPhoto} alt="" className="object-cover object-center w-full rounded-t-md md:h-44 lg:h-[270px] xl:h-[270px] dark:bg-gray-500" />
                                <div data-aos="fade-left" data-aos-duration = "500" className="flex flex-col justify-between flex-grow p-4 space-y-8">
