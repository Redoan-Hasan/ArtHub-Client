...
const UpdateExistingCraft = () => {
  ...
  const handleUpdateCraft = (e) => {
    ...
    fetch(
      `https://art-hub-server.vercel.app/updateExistingCraft/${oldCraft._id}`,
      {
        method: "PUT",
        headers: {
              ...
              <form onSubmit={handleUpdateCraft}>
                ...
                <div className="form-control py-2">
                  ...
                  <div className="text-lg font-semibold flex justify-start items-center gap-3">
                    <input
                      defaultChecked={oldCraft.customization === "Yes"}
                      type="radio"
                      name="customization"
                      id=""
                      value="Yes"
                    ...
                    <span>Yes</span>
                    <input
                      defaultChecked={oldCraft.customization === "No"}
                      type="radio"
                      name="customization"
                      id=""
                      value="No"
                ...
                <div className="form-control py-2">
                  ...
                  <div className="text-lg font-semibold flex justify-start items-center gap-3">
                    <input
                      defaultChecked={oldCraft.stockStatus === "In stock"}
                      type="radio"
                      name="stockStatus"
                      id=""
                      value="In stock"
                    ...
                    <span>In Stock</span>
                    <input
                      defaultChecked={oldCraft.stockStatus === "Made to order"}
                      type="radio"
                      name="stockStatus"
                      id=""
                      value="Made to order"
