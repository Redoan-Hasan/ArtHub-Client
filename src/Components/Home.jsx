    ...
    return (
        <div>
            <div>
                ...
                <div className="max-w-screen-xl mx-auto">
                    <h1 className="text-4xl md:text-5xl lg:text-5xl font-bold text-center py-2 md:py-10 lg:py-10">Arts And Crafts</h1>
                    <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-3 gap-5 px-4 py-4">
                        {
                            craftsCards.map(arts => <Arts key={arts._id} arts={arts}></Arts>)
                        }
                    </div>
                </div>
            </div>
