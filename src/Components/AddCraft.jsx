                ...
                <form onSubmit={handleAddCraft}>
                    ...
                    <div className="form-control py-2">
                        ...
                        <div className="text-lg font-semibold flex justify-start items-center gap-3">
                            <input type="radio" name="customization" id="" value='Yes' required/><span>Yes</span>
                            <input type="radio" name="customization" id="" value='No' required/><span>No</span>
                        </div>
                    </div>
                    <div className="form-control py-2">
                        <label className="label">
                        ...
                        <div className="text-lg font-semibold flex justify-start items-center gap-3">
                            <input type="radio" name="stockStatus" id="" value='In stock' required/><span>In Stock</span>
                            <input type="radio" name="stockStatus" id="" value='Made to order' required/><span>Made To Order</span>
                        </div>
                    </div>
                    <div className="form-control py-2 font-raleway">
                    <label className="label">
